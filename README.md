...
- **Medición de precisión**: Firmware para Arduino y ESP32 Dev Module (MicroPython) que calcula la velocidad detectando el paso del proyectil por barreras de sensores ópticos (infrarrojos).
...
├── imported_cronografo/      # Firmware para dispositivos de hardware (Arduino y ESP32 Dev Module)
│   ├── arduino/              # Código C++ (.ino) para Arduino
│   └── (archivos .py)        # Scripts de MicroPython para ESP32 Dev Module (con soporte MQTT, Web y OLED)
